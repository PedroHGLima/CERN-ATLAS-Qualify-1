...
alg.add_quadrant( "HLT_e140_lhloose_nod0_ringer_v8"  , "EMU_e140_lhloose_nod0_ringer_v8", # Ringer v8
...
alg.plot(outputs, outputs, ['Quadrant Analysis e140 lhloose ringer-v8 vs ringer-v11 (data17-EGAM1)'] ,legends=legends, doPDF=True)
