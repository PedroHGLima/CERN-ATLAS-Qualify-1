...
alg.add_quadrant( "HLT_e26_lhtight_nod0_ringer_v8_ivarloose"  , "EMU_e26_lhtight_nod0_ringer_v8_ivarloose", # Ringer v8
...
alg.plot(outputs, outputs, ['Quadrant Analysis e26 lhtight ringer-v8 vs ringer-v11 (data17-EGAM1)'] ,legends=legends, doPDF=True)
