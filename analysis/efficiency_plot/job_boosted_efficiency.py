...
triggerList = [
    ...
    Group(Chain('EMU_e26_lhtight_nod0_ringer_v11_ivarloose',
                'L1_EM3', 'HLT_e26_lhtight_nod0_ringer_v11_ivarloose'), 'el_lhtight', 26),
    ...
    Group(Chain('EMU_e60_lhmedium_nod0_ringer_v11',
                'L1_EM3', 'HLT_e60_lhmedium_nod0_ringer_v11'), 'el_lhmedium', 60),
    ...
    Group(Chain('EMU_e140_lhloose_nod0_ringer_v11',
                'L1_EM3', 'HLT_e140_lhloose_nod0_ringer_v11'), 'el_lhloose', 140),
...
alg = EfficiencyTool( "Efficiency", dojpsiee=False )
